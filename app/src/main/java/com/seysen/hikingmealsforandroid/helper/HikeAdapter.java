...
public class HikeAdapter extends RecyclerView.Adapter<HikeAdapter.HikeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HikeViewHolder hikeViewHolder, int i) {
        ...
        hikeViewHolder.weightView.setText(String.format("%.1f", + hike.getWeight()*hike.getQuantity()).replace(",", "."));
        hikeViewHolder.personWeightView.setText(String.format("%.1f", + hike.getWeight()).replace(",", "."));
    }
